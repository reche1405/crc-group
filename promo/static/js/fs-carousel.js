class FullScreenCarousel {
    constructor(options = {}) {
        ...
        // DOM Elements
        this.wrapper = document.querySelector('.fs-carousel');
    ...
    renderThumbnails() {
        ...
        this.items.forEach((item, index) => {
            ...
            thumbnail.className = 'fs-gallery-selector';
        ...
        if (skipAnimation) {
            ...
            if (currentSlide && currentSlide.isDuplicate) {
                ...
                setTimeout(() => {
                    ...
                    const thumbnails = document.querySelectorAll('.fs-gallery-selector');
    ...
    selectSlide(index) {
        ...
        // Add visual feedback
        const thumbnail = document.querySelector(`.fs-gallery-selector[data-index="${index}"]`);
        if (thumbnail) {
